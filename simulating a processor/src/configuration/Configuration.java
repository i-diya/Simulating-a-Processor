...
public class Configuration {	
	...
	public static int Cache_iLatency;
	public static int Cache_dLatency;
	public static void parseConfiguratioFile(String configFileName)
	{
		...
		Cache_iLatency = Integer.parseInt(getImmediateString("Cache_iLatency", elmnt));
		Cache_dLatency = Integer.parseInt(getImmediateString("Cache_dLatency", elmnt));
	}
