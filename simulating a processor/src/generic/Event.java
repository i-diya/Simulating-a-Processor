...
public class Event {
	...
	public enum EventType {ExecutionComplete, MemoryRead, MemoryResponse, MemoryWrite,Cache_iWrite,Cache_iRead,Cache_iResponse,Cache_dWrite,Cache_dRead,Cache_dResponse};
